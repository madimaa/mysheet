...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'MySheet - sheetify the world'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  late Future<List<String>> listItems;

  void _saveName() {
    setState(() {
      String name = _nameController.text;
      listItems.then((value) => value.add(name));
      DataHandler().sendData(name);
    });
  }
